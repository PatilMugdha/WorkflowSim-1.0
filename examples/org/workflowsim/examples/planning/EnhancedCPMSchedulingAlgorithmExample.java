...
public class EnhancedCPMSchedulingAlgorithmExample extends WorkflowSimBasicExample1 {
	...
	public static List<CondorVM> createTenFixedVM(int userId) {
		...
		vm[0] = new CondorVM(0, userId, 120, 1, 2048, (long) 300, size, vmm, new CloudletSchedulerSpaceShared());
		list.add(vm[0]);

		vm[1] = new CondorVM(1, userId, 198, 2, 2048, (long) 900, size, vmm, new CloudletSchedulerSpaceShared());
		list.add(vm[1]);

		vm[2] = new CondorVM(2, userId, 152, 2, 2048, (long) 850, size, vmm, new CloudletSchedulerSpaceShared());
		list.add(vm[2]);

		vm[3] = new CondorVM(3, userId, 444, 4, 2048, (long) 725, size, vmm, new CloudletSchedulerSpaceShared());
		list.add(vm[3]);

		vm[4] = new CondorVM(4, userId, 230, 1, 2048, (long) 300, size, vmm, new CloudletSchedulerSpaceShared());
		list.add(vm[4]);

		vm[5] = new CondorVM(5, userId, 298, 2, 2048, (long) 350, size, vmm, new CloudletSchedulerSpaceShared());
		list.add(vm[5]);

		vm[6] = new CondorVM(6, userId, 120, 4, 2048, (long) 800, size, vmm, new CloudletSchedulerSpaceShared());
		list.add(vm[6]);

		vm[7] = new CondorVM(7, userId, 150, 4, 2048, (long) 950, size, vmm, new CloudletSchedulerSpaceShared());
		list.add(vm[7]);

		vm[8] = new CondorVM(8, userId, 120, 2, 2048, (long) 750, size, vmm, new CloudletSchedulerSpaceShared());
		list.add(vm[8]);

		vm[9] = new CondorVM(9, userId, 110, 1, 2048, (long) 625, size, vmm, new CloudletSchedulerSpaceShared());
		list.add(vm[9]);
